...
util.func private @sharktank_pooling_nchw_sum_{{N_out}}x{{C_out}}x{{H_out}}x{{W_out}}_{{weights_H}}x{{weights_W}}_{{strides_H}}_{{strides_W}}_{{dilations_H}}_{{dilations_W}}_{{dtype}} (

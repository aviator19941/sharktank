...
def qconv2d_tensor_scaled_integer(
    ...
    *,
    ...
    y_qs = kernels.conv_2d_nchw_fchw(input_qs.to(torch.int32), padded_input.to(torch.int32), weight_qs.to(torch.int32), bias_qs.to(torch.int32), stride, padding, dilation)
